...
def test():
    ...
    checkpoint.restore(tf.train.latest_checkpoint('./save_lethsy'))
...
def train():
    ...
    log_dir = 'lethsy_tensorboard_logs'
    ...
    for batch_index in range(num_batches):
        ...
        if batch_index % 100 == 0:
            checkpoint.save(f'./save_lethsy/{batch_index}_lethsyModel.ckpt')
